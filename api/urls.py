...
urlpatterns = [
    ...
    path("forum/<uuid:forum_id>/delete-forum/", api_delete_forum, name="api_delete_forum"),
    path("forum/<uuid:forum_id>/edit-forum/", api_edit_forum, name="api_edit_forum"),
    ...
    path("forum/comments/<uuid:comment_id>/delete/", api_delete_comment, name="api_delete_comment"),
