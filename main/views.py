...
from .models import Team, Match, News, Player, Person
...
def homepage(request):
    ...
    # Pisahkan berita berdasarkan thumbnail
    ...
    teams = Team.objects.all().order_by("-goals")
...
def player_list(request):
    """Tampilkan daftar semua pemain"""
    player_list = Player.objects.all().order_by('-likes')
    paginator = Paginator(player_list, 12)
